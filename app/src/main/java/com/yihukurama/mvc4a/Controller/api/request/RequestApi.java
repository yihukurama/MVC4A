...
public class RequestApi {
    ...
    public static void loginRequest(LoginActivity noHttpCB,Context context,RequestParams requestParams){
        ...
        requestQueue.add(RequestSinal.login, mRequest, noHttpCB);// 这里的what，先用0代替，正式开发中，多个请求使用同一个Listener时，要传入不同的what，相当于handler的what一样
    }
